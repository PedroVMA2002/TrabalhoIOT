...
const char* ssid = "Pvnomoreira";      //--> Enter your SSID / your WiFi network name.
const char* password = "25421288";  //--> Enter your WiFi password.
/* ======================================== */

/* ======================================== Variables for telegram bot tokens. */
String BOTtoken = "8050830814:AAF5OVw49UfvdPY0X8irOq-P7QLEGUcpqw4";  //--> your Bot Token (Get from Botfather).
/* ======================================== */

/* ======================================== @myidbot ID */
// Use @myidbot to find out the chat ID of an individual or a group.
// Also note that you need to click "start" on a bot before it can message you.
String CHAT_ID = "898633179";
/* ======================================== */
